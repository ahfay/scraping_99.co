...
class CreateDataframe:
    ...
    def dataframe_kec(self, data, dir_kab, c):
        coloumn = ['harga','luas_tanah','luas_bangunan', 'lantai', 'kamar_tidur','kamar_mandi','garasi','carpots','daya_listrik','type','sertifikat','tanggal','kec','kab/kota','prov','alamat_lengkap','link']
        data = data[1:]
